...
//       try {
//         const response = await fetch(`https://enfros-solutions-backend-1.onrender.com/api/v1/sites/site-details`, {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           body: JSON.stringify({
//             action: "add",
...
//         `https://enfros-solutions-backend-1.onrender.com/api/v1/payment/create/order`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
//         `https://enfros-solutions-backend-1.onrender.com/api/v1/payment/verify/order`,
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//       await fetch(`https://enfros-solutions-backend-1.onrender.com/api/v1/sites/site-details`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
//           action: "add",
...
//           `https://enfros-solutions-backend-1.onrender.com/api/v1/sites/site-details`,
//           {
//             method: "POST",
//             headers: { "Content-Type": "application/json" },
//             body: JSON.stringify({
...
const UserProfile = ({ nft, goBack }) => {
  ...
  const verifyPayment = async (response) => {
    ...
    try {
      ...
      // await mintNFTs(userDetails.walletAddress, kWp);
      const mintResponse = await fetch(
        `https://enfros-solutions-backend-1.onrender.com/api/v1/mint`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
